...
export default function Chat({myData, selectedUser}) {
  ...
  return (
    <>
    <Pressable onPress={ChatApp.onBack} style={styles.actionBar}>
    <MaterialIcons style={styles.backArrow} name="arrow-back" size={30} color="black" />
